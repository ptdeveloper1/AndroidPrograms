...
/******************** if debug is set true then it will show all Logcat message ************/
    ...
    /******************** Table Fields ************///name of the columns,as they wont change, these are constants
    ...
    /** Table names */
    public static final String USER_TABLE = "tbl_user1";//use letters numbers _
    ...
    protected DataAdapter() {//EMPTY CONSTRUCTOR
    }
    /******************* Initialize database *************/
    ...
    private static class DataBaseHelper extends SQLiteOpenHelper {//inner class
        public DataBaseHelper(Context context) {
            super(context, DATABASE_NAME, null, DATABASE_VERSION);//if ONLLY SUPER() IS mentioned then it is CONSTRUCTOR
        }
